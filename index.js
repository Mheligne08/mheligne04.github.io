...
var order qty2.value.toString() + pc/s x //carts.textContent += carts.value.toString() price2.textContent "\n"; product2.textContent Php (parseFloat (qty2.value) *parseFloat (price2.textConten
